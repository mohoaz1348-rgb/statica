...
Количество ПНОП выросло, но неудобств не вызвало т.к. это увеличение вызвано биграммой `тв` на указательном пальце, которая удобно и быстро набирается. Вывод: при создании раскладки не нужно гнаться за уменьшение ПНОП любой ценой! У меня есть варианты раскладки, у которой ПНОП меньше единицы, но она будет менее удобна, чем данная раскладка.

После этого изменения раскладки мне потребовался уже месяц для того чтобы восстановить скорость. Я тренируюсь на сайте клавогонок - прогресс можно посмотреть здесь:
