...
## ВАЖНО!!!
Буква `п` нажимается указательным пальцем, `ы` – средним, `э` – безымянным, `ъ` - средним (так называемый Angle Mod). Если нажимать по другому, то параметры раскладки ухудшатся. `,` нажимается левым или правым указательным пальцем в зависимости от ситуации. Если для вас сложно нажимать разными руками, то рекомендую закрепить запятую за левой рукой.
...
По сравнению со стандартной версией раскладки изменили положение следующие буквы: ф -> й -> д -> в -> "большой палец правой руки".
...
ъ э ы п ф  й д ч ш ц 
           в
```
ПРЕДУПРЕЖДЕНИЕ! Перенос буквы "в" с большого пальца правой руки на большой палец левой руки не рекомендуется из-за того, что перенаправления значительно возрастут.
...
- `:` находится на клавише с точкой (и нажимается с шифтом), а `;` вместе с запятой (это интуитивно понятно и легко запоминается).
...
8. `це` – довольно частая (0,150% - 174 место)
9. `иц` – довольно частая (0,119% - 211 место)
10. `рт` - довольно частая (0,117% - 213 место)
11. `йс` – нечастая (0,093% - 234 место)
12. `фи` – нечастая (0,074% - 260 место)
...
На левой руке `ы`, нажимаемая средним пальцем со своими 1,90% проигрывает Зубачеву и Диктору. Но это дискомфорта у меня не вызывает, т.к. `ы` не создает неудобных биграмм на левой руке.
...
Когда максимальная скорость начала приближаться к 350 знаков в минуту - я начал замечать перегрузку правого мизинца. Подумал, что проблема решится отправкой `б` на указательный палец, а `щ` отправил на мизинец. Создал второй вариант раскладки:
...
Считаю, что прогресс неплохой, т.к. месяц и десять дней были потрачены на переучивание новых вариантов раскладки. Ну и мне 45 лет. Как выяснили на клавогонках - чем больше возраст, тем медленнее прогресс. Даже график составили - https://klavogonki.ru/forum/general/435/page10/#post203. Пока у меня прогресс как у 25-30-летнего.
...
Существует мнение, что набор перекатами убеличивает скорость набора. Но, по-моему, тут путают причину и следствие. Сначала (при освоении раскладки) надо набирать текст думая об отдельном символе. И только после достижения некоторой скорости начинать думать "перекатами" и начинать использовать самые частые и удобные из них. Именно возросшая скорость печати и восприятия текста позволяет набирать перекатами, а не наоборот. Я убедился на этом на практике. Создал словарь биграмм, которые набираются перекатами и попытался в начале обучения новой раскладке понабирать его думая о перекатах - скорость упала почти в два раза! Поэтому перекаты должны осваиваться не сознательным усилием - их освоение придет как бы "само собой". При росте скорости, мозги будут успевать определить следующий перекат и подать сигнал о его наборе.

Первые проблески свободного набора начали возникать только на средней скорости около 270 знаков в минуту. Вторые проблески свободного набора возникли на средней скорости 350 знаков в минуту. На этой скорости я освоил почти все перекаты, и то не достаточно уверенно. Т.е. освоение перекатов это довольно сложная тема, по-крайней мере для меня.
