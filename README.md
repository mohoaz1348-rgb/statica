...
## ВАЖНО!!!
Буква `п` нажимается указательным пальцем, `ы` – средним, `э` – безымянным, `ъ` - средним (так называемый Angle Mod). Если нажимать по другому, то параметры раскладки ухудшатся. `,` нажимается левым или правым указательным пальцем в зависимости от ситуации.
